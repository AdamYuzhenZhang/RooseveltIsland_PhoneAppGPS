...
public class MQTTReceiver : M2MqttUnityClient
{
    ...
    public string topicSubscribe = "IDD/AdamHCI"; // topic to subscribe. !!! The multi-level wildcard # is used to subscribe to all the topics. Attention i if #, subscribe to all topics. Attention if MQTT is on data plan
